        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6 sm:p-8">
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">2. Use of the Service</h2>
                
                <h3 className="text-lg font-medium text-slate-100 mb-3">2.1 Eligibility</h3>
                <p className="text-slate-300 mb-4">
                ...
                <h3 className="text-lg font-medium text-slate-100 mb-3">2.2 Permitted Use</h3>
                ...
                <h3 className="text-lg font-medium text-slate-100 mb-3">2.3 Prohibited Uses</h3>
                <p className="text-slate-300 mb-3">You are prohibited from:</p>
                <ul className="list-disc list-inside text-slate-300 mb-4 space-y-1">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">3. Account and Wallet</h2>
                <p className="text-slate-300 mb-3">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">4. Intellectual Property</h2>
                <p className="text-slate-300">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-300 mb-3">To the fullest extent permitted by law:</p>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">6. Termination</h2>
                <p className="text-slate-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">7. Governing Law</h2>
                <p className="text-slate-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">8. Changes to These Terms</h2>
                <p className="text-slate-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-slate-100 mb-4">9. Contact Us</h2>
                <p className="text-slate-300">
