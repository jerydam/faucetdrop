...
export function BatchClaim({ faucetAddress }) {
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="space-y-2">
            <Textarea placeholder="Enter addresses (one per line or comma separated)" value={addresses} onChange={(e) => setAddresses(e.target.value)} rows={5} disabled={isProcessing}/>
