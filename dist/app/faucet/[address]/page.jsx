...
export default function FaucetDetails() {
    ...
    // Add a new function for claiming via backend after the handleClaim function
    ...
    if (loading) {
        return (<div className="container mx-auto px-4 py-8 flex justify-center items-center min-h-[50vh]">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex justify-between items-center">
                    ...
                    {faucetDetails.isClaimActive ? (<span className="text-sm bg-green-500/20 text-green-600 dark:text-green-400 px-3 py-1 rounded-full">
                        Active
                      </span>) : (<span className="text-sm bg-red-500/20 text-red-600 dark:text-red-400 px-3 py-1 rounded-full">
                        Inactive
                      </span>)}
                  </CardTitle>
                  <CardDescription>
                ...
                <CardFooter className="flex flex-col gap-2">
                  <Button className="w-full" onClick={handleClaim} disabled={isClaiming || !isConnected || !faucetDetails.isClaimActive || hasClaimed}>
                    {isClaiming
                ? "Claiming..."
                : hasClaimed
                    ? "Already Claimed"
                  ...
                  <Button className="w-full" variant="outline" onClick={handleBackendClaim} disabled={isClaiming || !address || !faucetDetails.isClaimActive || hasClaimed}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input id="fund-amount" placeholder="0.0" value={fundAmount} onChange={(e) => setFundAmount(e.target.value)}/>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input id="withdraw-amount" placeholder="0.0" value={withdrawAmount} onChange={(e) => setWithdrawAmount(e.target.value)}/>
                      ...
                      <TabsContent value="parameters" className="space-y-4 mt-4">
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <Input id="claim-amount" placeholder="0.0" value={claimAmount} onChange={(e) => setClaimAmount(e.target.value)}/>
                      ...
                      <TabsContent value="whitelist" className="space-y-4 mt-4">
                        <div className="space-y-4">
                          <div className="flex items-center space-x-2">
                            <Switch id="whitelist-mode" checked={isWhitelistEnabled} onCheckedChange={setIsWhitelistEnabled}/>
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea id="whitelist-addresses" placeholder="0x..." value={whitelistAddresses} onChange={(e) => setWhitelistAddresses(e.target.value)} rows={5}/>
                          </div>
