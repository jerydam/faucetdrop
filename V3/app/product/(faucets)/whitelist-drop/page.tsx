...
export default function WhitelistDrop() {
    ...
    const features = [
        ...
        { textHead: "Bulk Uploads", textBody: "Easily upload CSVs of wallet addresses to authorize hundreds of users in one click." },
    ...
    const howItWorks = [
        { textHead: "Define the List", textBody: "Upload your list of eligible wallet addresses (e.g., DAO members, NFT holders)." },
        ...
        { textHead: "Secure Claim", textBody: "Users connect their fir wallets; the contract verifies their eligibility and releases funds." }
    ]

    //   don't forget to Change picture
    const useCases = [
        { textHead: "DAO Distributions", textBody: "Monthly rewards for active governance members.", image: "/learnMore/conference.png" },
        { textHead: "Mainnet Incentives", textBody: "Distribute tokens securely to approved developers and users.", image: "/learnMore/podcast.png" },
    ]
    return (
