...
//  // Step 1: Faucet Type Selection (Complete Function)
...
//               </CardTitle>
//             </div>
//             <CardDescription>Advanced Custom Logic</CardDescription>
//           </CardHeader>
//           <CardContent>
//             <p className="text-sm text-gray-600">
//               Fully customizable faucet with advanced rules and API integration.
//             </p>
//             {!isFaucetTypeAvailableOnNetwork(FAUCET_TYPES.CUSTOM) && network && (
//               <div className="flex items-center space-x-2 mt-2">
//                 <p className="text-xs text-red-600">Not available on</p>
//                 <NetworkImage network={network} size="xs" />
//                 <span className="text-xs text-red-600">{network.name}</span>
