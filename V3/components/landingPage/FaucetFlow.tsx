...
const FaucetFlow = () => {
    ...
    const nodes = [
        { id: 1, title: 'Create a faucet', x: 150, y: 80, color: '#f97316', icon: '/favicon.png'  },
        { id: 2, title: 'Choose a distribution type', x: 550, y: 180, color: '#10b981', icon: '/favicon.png' },
        { id: 3, title: 'Add tasks, quests or quizzes', x: 150, y: 280, color: '#ef4444', icon: '/favicon.png' },
        { id: 4, title: 'Fund your faucet', x: 550, y: 380, color: '#f59e0b', icon: '/favicon.png' },
        { id: 5, title: 'Share your compaign link', x: 150, y: 480, color: '#8b5cf6', icon: '/favicon.png' },
        { id: 6, title: 'Users participate -> qualify -> drip', x: 550, y: 580, color: '#ec4899', icon: '/favicon.png' }
    ];
    ...
    const calculateSegmentLength = (points: any[]) : number => {
        let length = 0;
    ...
    return (
        <div className="w-full min-h-screen p-8">
            <div className="max-w-5xl mx-auto">
                ...
                <svg width="800" height="700" className="mx-auto">
                    <defs>
                    ...
                    {nodes.map((node) => (
                        <g key={node.id}>
                            ...
                            {/* Icon */}
                            <foreignObject x={node.x - 40} y={node.y - 40} width="80" height="80">
                                <div style={{
                                    width: '80px',
                                    height: '80px',
                                    // background: `url(${node.icon}) no-repeat center center`,
                                    backgroundSize: 'contain',
                                    textAlign: 'center',
                                    lineHeight: '80px',
                                    fontSize: '24px'
                                }}>
                                    <Image src={node.icon} alt="icon" width={80} height={80} />
                                </div>
                            </foreignObject>
