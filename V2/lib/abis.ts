    ...
    outputs: [
      {
        ...
        internalType: "struct FaucetDropsCustom.ClaimDetail[]",
        name: "",
        type: "tuple[]",
      },
    ],
		...
		"outputs": [
			{
				...
				"internalType": "struct TransactionStorage.TransactionData[]",
				"name": "",
				"type": "tuple[]"
			}
		],
