    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        >
           ...
           *
           * Providers (Privy + Wagmi + QueryClient)  ← EVM
           *   SolanaProviders                         ← Solana adapter
           *     NetworkProvider                       ← reads BOTH wallets
           *       WalletProvider                      ← your app wallet abstraction
           *
           * NetworkProvider imports useSolanaWallet from @solana/wallet-adapter-react,
           * so it MUST sit inside SolanaProviders.
           */}
          <Providers>
            <SolanaProviders>
              <NetworkProvider>
